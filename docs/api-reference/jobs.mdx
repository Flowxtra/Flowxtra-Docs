---
title: Jobs API
description: Create, update, publish, and manage job postings programmatically with the Flowxtra Jobs API — list, create, update status, and retrieve job details.
icon: Briefcase
---
