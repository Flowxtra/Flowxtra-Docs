...
description: Manage your Flowxtra subscription plans, the 14-day free trial, payment methods, and billing information.
icon: CreditCard
---
...
- All your jobs and applications remain accessible

<Callout type="info">
Since all plans include unlimited jobs and applications, downgrading won't affect your existing data.
</Callout>
...
- Applications this month: Unlimited
- API calls: X / limit
...
<Callout type="info">
All plans include unlimited job postings and applications. Only API calls have rate limits based on your plan.
</Callout>
...
- [Manage Team Members](/user-guide/account/team-permissions)
- [Create Your First Job](/user-guide/getting-started/first-job)
- [Explore Advanced Features](/user-guide/advanced/job-widget)
