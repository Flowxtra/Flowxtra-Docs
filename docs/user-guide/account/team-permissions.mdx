...
description: Invite team members and assign role-based permissions on Flowxtra — from Owner to custom roles with five access levels.
icon: Users
---
...
- [Configure Subscription & Billing](/user-guide/account/subscription-billing)
