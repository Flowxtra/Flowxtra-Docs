...
description: The Flowxtra CLI (@flowxtra/cli) — a scriptable, CI-ready command-line tool with 36 commands to post jobs, review candidates, and manage hiring workflows.
icon: Terminal
---
